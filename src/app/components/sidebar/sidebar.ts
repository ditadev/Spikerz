...
export class SidebarComponent {
  ...
  menuItems: MenuItem[] = [
    { icon: 'grid', label: 'Lorem' },
    { icon: 'alert-triangle', label: 'Lorem' },
    { icon: 'file-text', label: 'Lorem' },
    { icon: 'target', label: 'Lorem', active: true },
    { icon: 'settings', label: 'Lorem' },
    { icon: 'folder', label: 'Lorem' },
    { icon: 'box', label: 'Lorem' },
    { icon: 'layers', label: 'Lorem' },
  ];
  ...
  // Icon SVG paths - using simple icons
  getIconSvg(iconName: string): SafeHtml {
    const icons: Record<string, string> = {
      ...
      'settings': '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M12 1v6m0 6v6m5.196-15.804L13.5 6.893m-3 3L7.804 6.196m12.392 5.196L16.5 13.089m-9 0L3.804 16.785m0-9.589L7.5 10.893m9 0l3.696-3.697"/></svg>',
      ...
      'chevron-left': '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>',
      'chevron-right': '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg>',
    };
    return this.sanitizer.bypassSecurityTrustHtml(icons[iconName] || icons['grid']);
  }
}